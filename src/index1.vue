...
<!--                <div :style="'font-size:'+fontsize+'px;'" :class="isshowpic?'imglist-item-title':'imglist-item-title2'"-->
<!--                     v-if="isshow"><span>{{item.label}}</span></div>-->
<!--            </div>-->
<!--        </div>-->
    </div>
</template>
    ...
    export default {
        ...
        props: { // 设置该元素支持的属性配置
            ...
            imglist: {
                ...
                default: function () {
                    return [{
                        showimg: !1, label: "今年端午节为21世纪并列最晚", icourl: "", imgurl: "images/1.jpg", imgid: 0,
                    }, {
